...
private constructor(val themeId: Int, @JvmField val mStyleId: Int) {
    ...
    companion object {
        ...
        const val THEME_MATERIAL_GREEN = "material_green"
        const val THEME_MATERIAL_RED = "material_red"
        const val THEME_MATERIAL_BLUE = "material_blue"
        const val THEME_MATERIAL_YELLOW = "material_yellow"
        fun getAvailableDefaultColors(prefs: SharedPreferences, isNight: Boolean) = listOfNotNull(
            THEME_MATERIAL_GREEN,
            THEME_MATERIAL_RED,
            THEME_MATERIAL_BLUE,
            THEME_MATERIAL_YELLOW,
